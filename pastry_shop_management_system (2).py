...
"""
        specialties_label = tk.Label(scrollable_frame, text=specialties_text, font=("Times New Roman", 16, "italic"), fg="#4D2600", bg="#FFB6C1", justify="center", wraplength=1250)
...
"""
    ...
    def show_shop_page(self):
        ...
        for category_name, category_function in categories:
            tk.Button(self.main_menu_frame, text=category_name, font=("Times New Roman", 14), bg="#4D2600", fg="WHITE", command=category_function, width=40, height=2).pack(pady=10, padx=20)
    ...
    def add_to_cart(self, product_name, price, quantity_entry):
        try:
            ...
            if quantity <= 0:
                messagebox.showwarning("Invalid Quantity", "Please enter a quantity greater than zero.")
                return
        except ValueError:
